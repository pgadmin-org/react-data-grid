import { createContext, memo, useCallback, useContext, useEffect, useEffectEvent, useImperativeHandle, useLayoutEffect, useMemo, useRef, useState } from "react";
...
function Cell({ column, colSpan, isCellSelected, isDraggedOver, row: row$1, rowIdx, className, onMouseDown, onCellMouseDown, onClick, onCellClick, onDoubleClick, onCellDoubleClick, onContextMenu, onCellContextMenu, onRowChange, selectCell, style, rangeSelectionMode, onMouseDownCapture, onMouseUpCapture, onMouseEnter,...props }) {
...
//#endregion
//#region src/Row.tsx
function Row({ className, rowIdx, gridRowStart, selectedCellIdx, isRowSelectionDisabled, isRowSelected, draggedOverCellIdx, lastFrozenColumnIndex, row: row$1, viewportColumns, selectedCellEditor, onCellMouseDown, onCellClick, onCellDoubleClick, onCellContextMenu, rowClass, onRowChange, selectCell, style, onMouseDownCapture, onMouseUpCapture, onMouseEnter, rangeSelectionMode, selectedCellsRange,...props }) {
	...
	function getViewportRows() {
		...
		for (let viewportRowIdx = startRowIdx; viewportRowIdx <= endRowIdx; viewportRowIdx++) {
			...
			rowElements.push(renderRow(key, {
				...
				onMouseDownCapture: () => setIsMouseRangeSelectionMode(true),
				onMouseUpCapture: () => {
